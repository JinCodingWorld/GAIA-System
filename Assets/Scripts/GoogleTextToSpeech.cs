...
public class GoogleCloudTTS : MonoBehaviour
{
    ...
    public string voiceName = "en-US-Journey-F";
    public string textVoice;

    public Text nameSpeakText;

    public AudioSource audioSource;
    private void Start()
    {
        Synthesize(textVoice);
    }
    private void Awake()
    {
        if (Instance == null)
    ...
    public void nameSpeak()
    {
        textVoice = nameSpeakText.text + ", Welcome to GAIA System!" + "Please enter your Email address and password to Identify yourself.";
        Synthesize(textVoice);
    }
